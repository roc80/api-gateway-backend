...
public class Permission extends TableImpl<PermissionRecord> {
    ...
    /**
     * The reference instance of <code>api_gateway.permission</code>
     */
    ...
    /**
     * The column <code>api_gateway.permission.id</code>.
     */
    ...
    /**
     * The column <code>api_gateway.permission.code</code>.
     */
    public final TableField<PermissionRecord, String> CODE = createField(DSL.name("code"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>api_gateway.permission.name</code>.
     */
    public final TableField<PermissionRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR.nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>api_gateway.permission</code> table reference
     */
    ...
    /**
     * Create a <code>api_gateway.permission</code> table reference
     */
    public Permission() {
    ...
    public List<UniqueKey<PermissionRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.PERMISSION_CODE_KEY, Keys.PERMISSION_NAME_KEY);
    }
    ...
    public RolePermissionMapPath rolePermissionMap() {
        if (_rolePermissionMap == null)
            _rolePermissionMap = new RolePermissionMapPath(this, null, Keys.ROLE_PERMISSION_MAP__ROLE_PERMISSION_MAP_PERMISSION_ID_FKEY.getInverseKey());
