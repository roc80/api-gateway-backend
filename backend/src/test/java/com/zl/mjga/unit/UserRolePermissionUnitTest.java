...
class UserRolePermissionUnitTest {
        ...
        Record mockRoleRecord =
                dslContext
                        .newRecord(
                                ...
                                ROLE.CODE,
                                ROLE.NAME,
                                DSL.field("permissions", Result.class))
    ...
    void pageQueryPermission_givenRoleId_shouldReturnPermissionDto() {
        ...
        PageResponseDto<List<PermissionDto>> pageResult =
                userRolePermissionService.pageQueryPermission(
                        PageRequestDto.of(0, 5), permissionQueryDto);
    ...
    void bindRoleToUser_givenNotExistRoleId_shouldRunError() {
        ...
        assertThatThrownBy(
                        () ->
                                userRolePermissionService.bindRoleToUser(
                                        stubUserId, List.of(stubRole.getId())))
    ...
    void bindPermissionToRole_givenExistPermissionId_shouldInsertRolePermissionMapWithNoError() {
        ...
        verify(rolePermissionMapRepository, times(1))
                .insert(Mockito.eq(List.of(rolePermissionMap)));
    }
