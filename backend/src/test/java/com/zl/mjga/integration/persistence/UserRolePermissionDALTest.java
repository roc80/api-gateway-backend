...
import static org.jooq.generated.api_gateway.tables.Permission.PERMISSION;
...
import org.jooq.generated.api_gateway.tables.pojos.Permission;
...
public class UserRolePermissionDALTest extends AbstractDataAccessLayerTest {
    ...
    @Sql(
            statements = {
                ...
                "INSERT INTO api_gateway.role (id, code, name) VALUES (1, 'testRoleA',"
                        + " 'testRoleA')",
    ...
    @Sql(
            statements = {
                ...
                "INSERT INTO api_gateway.permission (id, code, name) VALUES (1, 'testPermissionA',"
                        + " 'testPermissionA')",
                "INSERT INTO api_gateway.role_permission_map (role_id, permission_id) VALUES (1,"
                        + " 1)",
            })
    ...
    @Sql(
            statements = {
                ...
                "INSERT INTO api_gateway.role (id, code, name) VALUES (1, 'testRoleA',"
                        + " 'testRoleA')",
                "INSERT INTO api_gateway.role (id, code, name) VALUES (2, 'testRoleB',"
                        + " 'testRoleB')",
                "INSERT INTO api_gateway.permission (id, code, name) VALUES (1, 'testPermissionA',"
                        + " 'testPermissionA')",
                ...
                "INSERT INTO api_gateway.role_permission_map (role_id, permission_id) VALUES (2,"
                        + " 2)",
            })
    void getUserFlatBy() {
        ...
        List<String> names =
                records.stream()
                        .map(record -> record.get(PERMISSION.NAME))
    ...
    void pageFetchUserAggBy() {
        ...
        Result<Record> records =
                userRepository.pageFetchUserAggBy(pageRequestDto, new UserQueryDto());
        assertThat(records.size()).isEqualTo(2);
    ...
    void user_pageFetchBy() {
        ...
        Result<Record> records =
                userRepository.pageFetchUserBy(PageRequestDto.of(0, 10), rbacQueryDto);
        assertThat(records.size()).isEqualTo(2);
    ...
    void permission_pageFetchBy() {
        ...
        Result<Record> records =
                permissionRepository.pageFetchPermissionBy(
                        PageRequestDto.of(0, 10), permissionQueryDto);
